...
header('Content-Type: text/html; charset=utf-8');
	...
	$sql1 = "INSERT INTO pedidosrecebidos (`id`, `ticket`, `usuario`, `produto`, `variacao`, `data_pedido`, `id_pedido`, `doador`, `data_doacao`) VALUES (NULL, '$ticketdb', '$usuariodb', '$produtodb', '$variacaodb', '$datapedidodb', '$idpedidodb', '$doadordb', '$datadoacaodb')";
