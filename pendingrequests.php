...
<head>
	...
	<script>
		...
		document.addEventListener("DOMContentLoaded", function(event) { 
			$("#content-center").load("dbGetPRequests.php"); 
		});
		...
		function getSearchRequest(searchtxt) {
			...
			if(searchtxt==""){
				...
				$("#content-center").load("dbGetPSearchRequests.php", {ssearchtxt:searchtxt}); 
			}
		...
		function moveRequest(ticket) {
			...
			if (confirm("Deseja mover o pedido: "+ticket+" para o banco de dados de pedidos abertos?")) {
				$.post("dbMoveRequest1.php" , {sticket:ticket} , function(data){
					//$("#" + ticket).fadeOut('slow' , function(){$(this).remove();if(data)alert(data);});
				});	
			} else {
...
<body>
	...
	<div id="content-area">
		...
		<div id="content-top">
			<h2 style="margin-left: 20px;color:gray;"> Pedidos Pendentes </h2>
			<p style="margin-left: 20px;color:gray;"> Nesta página você poderá encotrar todos os pedidos pendentes encontrados no banco de dados. </p>
			...
			<div class="content-info" style="margin-top: -19px;">
				...
				<a class="far fa-handshake" style="Color: green;font-size:15px;"></a>
				<a style="font-size:12px">Confirmar recebimento</a>
				<a class="fas fa-recycle" style="Color: yellow;font-size:15px;"></a>
				<a style="font-size:12px">Mover pedido</a>
			</div>
