...
<head>
	...
	<script>
		...
		document.addEventListener("DOMContentLoaded", function(event) { 
			$("#content-center").load("dbGetUsers.php"); 
		});
...
<body>
	...
	<div id="content-area">
		...
		<div id="content-top">
			<h2 style="margin-left: 20px;color:gray;"> Usuários cadastrados </h2>
			<p style="margin-left: 20px;color:gray;"> Nesta página você poderá encotrar todos os usuários cadastrados no banco de dados. </p>
		</div>
