...
<body>
	...
	<div id="content-area">
		...
		<div id="content-top">
			<h2 style="margin-left: 20px;color:gray;"> Cadastrar Cliente </h2>
			<p style="margin-left: 20px;color:gray;"> Nesta página você poderá efetuar cadastros de novos clientes no sistema.</p>
			<input type="button" class="button-sub" onclick="location.href='client.php';" value="Lista Clientes (Voltar)" />
		</div>
		
		<div id="content-center">
			<form name="form-cad" action="dbInsertClient.php" autocomplete="off" method="POST">
				...
				<input type="submit" name="" value="Cadastrar Cliente" >
			</form>
		</div>
